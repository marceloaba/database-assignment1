-- Filename: mont0371-mend0152-DML.sql
...
DELETE FROM City_T; --Add: Dropping City_T table
DELETE FROM Country_T; --Add: Dropping Country_T table

-- Add: Insert Country data
